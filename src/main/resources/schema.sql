...
CREATE TABLE cooking_type (
                              cooking_type_id varchar(255)  NOT NULL,
                              name varchar(255)  NOT NULL,
...
CREATE TABLE complement (
                            complement_id varchar(255)  NOT NULL,
                            name varchar(255)  NOT NULL,
...
CREATE TABLE nutritional_information (
                                         nutritional_information_id varchar(255)  NOT NULL,
...
CREATE TABLE campus (
                        ...
                        open_hour jsonb  NOT NULL, -- Cambiado a jsonb para compatibilidad con PostgreSQL
...
CREATE TABLE campus_category (
                                 category_id varchar(255)  NOT NULL,
                                 campus_id varchar(255)  NOT NULL,
                                 CONSTRAINT campus_category_pk PRIMARY KEY (category_id,campus_id),
...
CREATE TABLE complement_promotion (
                                      complement_id varchar(255)  NOT NULL,
                                      promotion_id varchar(255)  NOT NULL,
                                      CONSTRAINT complement_promotion_pk PRIMARY KEY (complement_id,promotion_id),
...
CREATE TABLE product_complement (
                                    product_complement_id varchar(255)  NOT NULL,
                                    product_id varchar(255)  NOT NULL,
                                    complement_id varchar(255)  NOT NULL,
...
CREATE TABLE product_menu (
                              product_id varchar(255)  NOT NULL,
                              menu_id varchar(255)  NOT NULL,
                              CONSTRAINT product_menu_pk PRIMARY KEY (menu_id,product_id),
...
CREATE TABLE "order" (
                         ...
                         user_id varchar(255), -- Cambiado a varchar(255) para compatibilidad con PostgreSQL
...
CREATE TABLE order_complement (
                                  product_complement_id varchar(255)  NOT NULL,
                                  order_request_id varchar(255)  NOT NULL,
                                  CONSTRAINT order_complement_pk PRIMARY KEY (product_complement_id,order_request_id),
...
CREATE TABLE order_menu (
                            menu_id varchar(255)  NOT NULL,
                            order_request_id varchar(255)  NOT NULL,
                            CONSTRAINT order_menu_pk PRIMARY KEY (order_request_id,menu_id),
...
CREATE TABLE order_product (
                               product_id varchar(255)  NOT NULL,
                               order_request_id varchar(255)  NOT NULL,
                               CONSTRAINT order_product_pk PRIMARY KEY (product_id,order_request_id),
...
CREATE TABLE order_promotion (
                                 promotion_id varchar(255)  NOT NULL,
                                 order_request_id varchar(255)  NOT NULL,
                                 CONSTRAINT order_promotion_pk PRIMARY KEY (order_request_id,promotion_id),
